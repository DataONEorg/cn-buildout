...
PKGS          = dataone-cn-os-core.deb dataone-cn-metacat.deb dataone-cn-processdaemon.deb dataone-cn-rest-service.deb dataone-cn-portal.deb dataone-cn-version-tool.deb dataone-cn-solr.deb dataone-cn-index.deb 
...
upgrade: publish
	...
	apt-get remove dataone-cn-rest-service dataone-cn-metacat dataone-cn-mercury dataone-cn-processdaemon dataone-cn-portal dataone-cn-version-tool dataone-cn-solr dataone-cn-index
	apt-get autoremove
