...
upgrade: publish
	...
	apt-get remove dataone-cn-rest-service dataone-cn-metacat dataone-cn-processdaemon dataone-cn-portal dataone-cn-version-tool dataone-cn-solr dataone-cn-index dataone-mercury
	apt-get autoremove
...
#	apt-get remove dataone-cn-rest-service dataone-cn-metacat 
	apt-get autoremove
	@echo $(shell rm -rf /var/mercury)
	@echo $(shell rm -rf /var/metacat)
