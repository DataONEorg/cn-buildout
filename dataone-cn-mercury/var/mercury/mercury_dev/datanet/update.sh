...
##java -Xms512m -Xmx1024m -jar  Harvest_dataone.jar datanet daacmerged nodebug daacmerged
##java -Xms512m -Xmx1024m -jar Solr_feed_R23.jar datanet daacmerged nodebug mercury3_harvests_datanet datanet.log datanet_schema_xpath2.xml
