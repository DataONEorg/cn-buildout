...
#$solrSchemaFile ='./fwinitialfacetingfordataonemercury/schema.xml';

$xpathFile  = '../mercury_dev/datanet/datanet_schema_xpath2.xml';
#$xpathFile  = './fwinitialfacetingfordataonemercury/datanet_schema_xpath2.xml';
...
# else must be a one line input file...
    ...
    warn "Cannot open file $mdDoc2schema";
}
1;
